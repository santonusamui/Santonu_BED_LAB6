...
@Configuration
public class SRAWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
				.antMatchers("/", "/students/save", "/students/add-show-form", "/students/403", "/students/show")
				.hasAnyAuthority("REGULAR_USER", "ADMIN_USER")
				.antMatchers("/students/update-show-form", "/students/delete").hasAuthority("ADMIN_USER").anyRequest()
				.authenticated().and().formLogin().loginProcessingUrl("/login").successForwardUrl("/students/listing")
